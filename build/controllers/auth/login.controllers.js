...
const loginControllers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const access_token = jwt_services_1.default.sign({ _id: user._id, email: user.email });
        const refresh_token = jwt_services_1.default.sign({ _id: user._id, email: user.email }, config_1.JWT_SECRET_EXPIRES_IN, config_1.REFRESH_TOKEN);
        // if(!req.body.captchaexist)
